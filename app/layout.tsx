...
export const metadata: Metadata = {
  ...
  creator: "Dahn",
  openGraph: {
    title: "Dahn - Mobile Developer Portfolio",
    description:
      "Passionate mobile developer creating exceptional iOS and Android applications. Explore my projects and app development expertise.",
