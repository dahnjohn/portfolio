          ...
          <div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
                A self-taught mobile app developer, building real-world apps for
                over <span className="text-blue-400">2+ years</span> now. I
                craft intuitive and high-performing mobile experiences that
                balance user needs with product goals—powered by{" "}
                <span className="text-blue-400">React Native</span>,{" "}
                <span className="text-blue-400">TypeScript</span>, and modern
                web tech.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
              {["React", "TypeScript", "Node.js", "Next.js", "Rest API"].map(
                (tech) => (
                  <span
                    key={tech}
